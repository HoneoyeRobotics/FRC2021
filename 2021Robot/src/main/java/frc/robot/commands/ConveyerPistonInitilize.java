...
public class ConveyerPistonInitilize extends CommandBase {
  /**
   * Creates a new ConveyerPistonInitilize.
   */
  private final PowercellSystem powerCellSystem;
  public ConveyerPistonInitilize(PowercellSystem powerCellSystem) {
